        ...
        <form METHOD="post"  ACTION="insert_result.php">
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <INPUT TYPE ="text" NAME="name" placeholder="김땡땡"  VALUE=<?php echo $name ?>>
            ...
            <div class="col-md-6 mb-3">
             ...
             <INPUT TYPE ="text"  NAME="SSN" placeholder="000000-0000000" <?php echo $SSN ?> required >
              <div class="invalid-feedback">
                SSN을 입력해주세요.
              </div>
            </div>
            ...
            <label for="gender">gender :</label>
             <INPUT TYPE ="text" NAME="gender" placeholder="F/M" VALUE=<?php echo $gender ?>>
            <div class="invalid-feedback">
             gender를 입력해주세요.
            </div>
          </div>
		  <div class="col-md-6 mb-3">
            exam_date : <INPUT TYPE ="text" NAME="exam_date" placeholder="0-0-0" VALUE=<?php echo $exam_date ?>>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
		   ...
		   <div class="mb-3">
            ...
            <input type="text" class="form-control" id="phone_number" placeholder="010-0000-0000"<?php echo $phone_number ?> required>
            <div class="invalid-feedback">
              phone_number를 입력해주세요.
            </div>
          </div>
		  <div class="mb-3">
            ...
            <input type="text" class="form-control" id="license_number" placeholder="000000-0000001"<?php echo $license_number ?> >
            <div class="invalid-feedback">
		  ...
		  <div class="mb-3">
            ...
            <input type="text" class="form-control" id="physicianSSN" placeholder=""<?php echo $address ?> >
            <div class="invalid-feedback">
